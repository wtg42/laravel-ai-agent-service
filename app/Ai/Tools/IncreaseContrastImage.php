...
class IncreaseContrastImage implements Tool
{
    public function description(): Stringable|string
    {
        return 'Increase contrast on a local image file and return the new image path.';
    }
    ...
    {
        $outputPath = sprintf('adaptive-ocr/%s/step-%02d-contrast.png', $runId, $step);
