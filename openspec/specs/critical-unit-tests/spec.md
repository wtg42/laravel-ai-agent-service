...
Define the expected behavior for critical local unit test coverage that protects core name normalization logic and agent contract stability. Detailed implementation context is TBD.
